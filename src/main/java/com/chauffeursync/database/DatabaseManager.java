package com.chauffeursync.database;
    ...
    public static void initializeIfNeeded() {
        ...
        try (Connection conn = getConnection()) {
            ...
            if (!tableExists(conn, "Role")) {
                ...
                runSqlScript(conn, "/com/chauffeursync/db/schema.sql");
            } else {
    ...
    private static void runSqlScript(Connection conn, String resourcePath) throws Exception {
        try (
                BufferedReader reader = new BufferedReader(
                        new InputStreamReader(Objects.requireNonNull(DatabaseManager.class.getResourceAsStream(resourcePath)))
                );
